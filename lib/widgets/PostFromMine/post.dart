...
class CreatePost extends StatefulWidget {
  ...
  @override
  _PostState createState() => _PostState(currentUser: currentUser);
...
class _PostState extends State<CreatePost> {
  ...
  _PostState({Key key, @required this.currentUser});
  ...
  void onSendMessage(String content, int type) {  //khi ấn nút gửi tin nhắn đi, gửi kiểu tin nhắn và nội dung tin nhắn đi
    ...
    if (content.trim() != '') { //xử lý khoảng trắng
      ...
      post_from_mine_controller.CreateMyOwnPost(currentUser, content, media_url);
      //Lưu dữ liệu vào MySQL
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBar(
        title: new Text(
          'Create Post', style: new TextStyle(color: Colors.white),),
